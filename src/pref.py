...
class Ui_pref(object):
    def setupUi(self, pref):
        ...
        self.gridLayout.addWidget(self.anonDatBox, 3, 0, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setContentsMargins(-1, 0, -1, -1)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.clearCacheBut = QtWidgets.QPushButton(pref)
        self.clearCacheBut.setMinimumSize(QtCore.QSize(215, 0))
        self.clearCacheBut.setMaximumSize(QtCore.QSize(215, 16777215))
        self.clearCacheBut.setObjectName("clearCacheBut")
        self.horizontalLayout.addWidget(self.clearCacheBut)
        self.clearCacheLab = QtWidgets.QLabel(pref)
        font = QtGui.QFont()
        font.setItalic(True)
        self.clearCacheLab.setFont(font)
        self.clearCacheLab.setText("")
        self.clearCacheLab.setObjectName("clearCacheLab")
        self.horizontalLayout.addWidget(self.clearCacheLab)
    ...
    def retranslateUi(self, pref):
        ...
        self.clearCacheBut.setText(_translate("pref", "Clear cache"))
